...
require 'lugo.functions'
require 'lugo.keymaps'
--[[
...
-- refresh opened buffers when edited externaly
vim.o.autoread = true
...
require('lazy').setup({
  ...
  --   end,
  -- },
  -- don't forget where you leave your marks
